  ...
  $(document).ready(function () {
    ...
    ****************/
    ...
    var showRangeBubble = function (thumb) {
      ...
      thumb.velocity({ height: "30px", width: "30px", top: "-30px", marginRight: marginLeft }, { duration: 300, easing: 'easeOutExpo' });
    };
    ...
    $(document).on('input mousemove touchmove', range_wrapper, function (e) {
      ...
      if (range_mousedown) {
        ...
        thumb.addClass('active').css('right', offsetLeft);
    ...
    $(document).on('mouseout touchleave', range_wrapper, function () {
      if (!range_mousedown) {
        ...
        if (thumb.hasClass('active')) {
          thumb.velocity({ height: '0', width: '0', top: '10px', marginRight: marginLeft }, { duration: 100 });
        }
